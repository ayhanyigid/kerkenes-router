...
class RouterRewriteTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testStopMergeExceptionHandlers()
    {
        ...
        } catch (\Kerkenes\KerkenesRouter\Exceptions\NotFoundHttpException $e) {
    ...
    {
        $this->expectException(\Kerkenes\KerkenesRouter\Exceptions\NotFoundHttpException::class);
    ...
    public function testRewriteRouteFromRoute()
    {
        ...
        TestRouter::get('/match', function () {
            TestRouter::request()->setRewriteRoute(new \Kerkenes\KerkenesRouter\Route\RouteUrl('/match', function () {
                return 'ok';
            }));
        });
