 ...
 * ---------------------------
 *
 * This class is added so calls can be made statically like KerkenesRouter::get() making the code look pretty.
 * It also adds some extra functionality like default-namespace etc.
 */

namespace Kerkenes\KerkenesRouter;

use Closure;
use Exception;
use Kerkenes\Exceptions\InvalidArgumentException;
use Kerkenes\Http\Middleware\BaseCsrfVerifier;
use Kerkenes\Http\Request;
use Kerkenes\Http\Response;
use Kerkenes\Http\Url;
use Kerkenes\KerkenesRouter\ClassLoader\IClassLoader;
use Kerkenes\KerkenesRouter\Exceptions\HttpException;
use Kerkenes\KerkenesRouter\Handlers\CallbackExceptionHandler;
use Kerkenes\KerkenesRouter\Handlers\IEventHandler;
use Kerkenes\KerkenesRouter\Route\IGroupRoute;
use Kerkenes\KerkenesRouter\Route\ILoadableRoute;
use Kerkenes\KerkenesRouter\Route\IPartialGroupRoute;
use Kerkenes\KerkenesRouter\Route\IRoute;
use Kerkenes\KerkenesRouter\Route\RouteController;
use Kerkenes\KerkenesRouter\Route\RouteGroup;
use Kerkenes\KerkenesRouter\Route\RoutePartialGroup;
use Kerkenes\KerkenesRouter\Route\RouteResource;
use Kerkenes\KerkenesRouter\Route\RouteUrl;

class KerkenesRouter
{
    /**
     ...
     * Start routing
     *
     * @throws \Kerkenes\KerkenesRouter\Exceptions\NotFoundHttpException
     * @throws \Kerkenes\Http\Middleware\Exceptions\TokenMismatchException
     ...
     */
    public static function get(string $url, $callback, array $settings = []): IRoute
    {
     ...
     * @return RouteUrl|IRoute
     */
    public static function post(string $url, $callback, array $settings = []): IRoute
    {
     ...
     * @return RouteUrl|IRoute
     */
    public static function put(string $url, $callback, array $settings = []): IRoute
    {
     ...
     * @return RouteUrl|IRoute
     */
    public static function patch(string $url, $callback, array $settings = []): IRoute
    {
     ...
     * @return RouteUrl|IRoute
     */
    public static function options(string $url, $callback, array $settings = []): IRoute
    {
     ...
     * @return RouteUrl|IRoute
     */
    public static function delete(string $url, $callback, array $settings = []): IRoute
    {
     ...
     * @param array|null $settings
     * @return RouteUrl|IRoute
     * @see KerkenesRouter::form
     */
    public static function basic(string $url, $callback, array $settings = []): IRoute
    {
     ...
     * @see KerkenesRouter::form
     */
    public static function form(string $url, $callback, array $settings = []): IRoute
    {
        return static::match([
     ...
     * @return RouteUrl|IRoute
     */
    public static function match(array $requestMethods, string $url, $callback, array $settings = []): IRoute
    {
     ...
     * @return RouteUrl|IRoute
     */
    public static function all(string $url, $callback, array $settings = []): IRoute
    {
        $route = new RouteUrl($url, $callback);
     ...
     */
    public static function controller(string $url, string $controller, array $settings = []): IRoute
    {
     ...
     */
    public static function resource(string $url, string $controller, array $settings = []): IRoute
    {
