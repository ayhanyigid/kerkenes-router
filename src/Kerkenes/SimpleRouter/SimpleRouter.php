...
namespace Kerkenes\SimpleRouter;
...
use Kerkenes\SimpleRouter\ClassLoader\IClassLoader;
use Kerkenes\SimpleRouter\Exceptions\HttpException;
use Kerkenes\SimpleRouter\Handlers\CallbackExceptionHandler;
use Kerkenes\SimpleRouter\Handlers\IEventHandler;
use Kerkenes\SimpleRouter\Route\IGroupRoute;
use Kerkenes\SimpleRouter\Route\ILoadableRoute;
use Kerkenes\SimpleRouter\Route\IPartialGroupRoute;
use Kerkenes\SimpleRouter\Route\IRoute;
use Kerkenes\SimpleRouter\Route\RouteController;
use Kerkenes\SimpleRouter\Route\RouteGroup;
use Kerkenes\SimpleRouter\Route\RoutePartialGroup;
use Kerkenes\SimpleRouter\Route\RouteResource;
...
class SimpleRouter
{
     ...
     * Start routing
     *
     * @throws \Kerkenes\SimpleRouter\Exceptions\NotFoundHttpException
